...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 0
    answer = count_cosines_from(0, 5, 1)
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(15, 19, 0.4)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    # Test 5:
    expected = 1
    answer = count_cosines_from(7, 11, 0.1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    # Test 6:
    expected = 1
    answer = count_cosines_from(23, 27, 0.8)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3
    expected = 0.33611111  # This is APPROXIMATELY the correct answer.
